...
<body style="background-color:pink;">
	...
	<div class="container-fluid">
		<br>
		<p class="h1 text-center font-weight-bold">Registrarse</p>
		<br><br>
		<div class="row justify-content-md-center">
			<div class="col col-lg-4">
				<form method="post">
					...
					<div class="form-group col-md-auto">
						<button type="submit" class="btn btn-dark col-md-auto font-weight-bold" name="registrar">Registrarse</button>
					</div>
				</form>
			</div>
		</div>
		<div class="row justify-content-md-center">
			<div class="col col-md-auto">
				<div class="form-group">
					<label for="log" class="font-weight-bold">¿Ya tienes una cuenta?<a class="btn btn-link text-dark font-weight-bold" href="index.php">Ingresa aqui</a></label>
				</div>
			</div>
		</div>
	</div>
		...
		if($_POST['userreg'] == '' or $_POST['pwreg'] == ''){
			...
			if($existe == 0){
				if($_POST['pwreg'] == $_POST['pwregveri']){
					...
					$conexion->query("insert into usuarios (usuario, password, tipo, passencrip) values ('$nom', '$pw', '$tipo', '$pwEnc')");
